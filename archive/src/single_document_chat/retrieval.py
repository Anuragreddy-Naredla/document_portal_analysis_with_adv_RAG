...
class ConversationalRAG:
    def __init__(self, session_id: str, retriever):
        ...
        try:
            ...
            log.info("Created RAG chain", session_id=session_id)
            ...
            log.info("Wrapped chain with message history", session_id=session_id)
    ...
    def invoke(self, user_input: str) -> str:
        try:
            ...
            log.error("Failed to invoke conversational RAG", error=str(e), session_id=self.session_id)
