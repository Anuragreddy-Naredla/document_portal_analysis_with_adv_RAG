...
from archive.src.document_analyzer.data_ingestion import DocumentHandler       # Your PDFHandler class
...
#     ref_path = Path("D:\\d_data\\AnuragReddy_Naredla_python_data\\python\\data_science_concepts_github\\LLMOPS\project1\\document_portal_analysis_with_adv_RAG\\data\\document_compare\\Long_Report_V1.pdf")
#     act_path = Path("D:\\d_data\\AnuragReddy_Naredla_python_data\python\\data_science_concepts_github\\LLMOPS\\project1\\document_portal_analysis_with_adv_RAG\\data\\document_compare\\Long_Report_V2.pdf")
...
#     _ref_file, _act_file = comparator.save_uploaded_files(ref_upload, act_upload)
...
#         print("uploaded_filesuploaded_files==", uploaded_files)
#         retriever = ingestor.ingest_files(uploaded_files)
...
#         # question = "what is attention all you need research paper about?"
